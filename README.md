...
数据集为 **435 种北京地区有野生分布记录**的鸟类（不含纯逃逸/放生归化种与分类存疑记录），难度按在北京的罕见程度标注（easy 100 / normal 100 / hard 235）。

各字段来源：

- **中文名 / 学名 / 目科属分类**：《中国鸟类分类与分布名录》（郑光美主编）
- **北京分布与居留类型**：《北京鸟类名录》及公开观鸟记录
- **IUCN 濒危等级**：[IUCN 红色名录](https://www.iucnredlist.org)
- **国家重点保护 / 三有**：《国家重点保护野生动物名录》（2021）、《有重要生态、科学、社会价值的陆生野生动物名录》（2023）
- **体长 / 翼展**：常见鸟类图鉴的典型范围中值，仅供参考

欢迎补充和纠错——直接在 issue 中提出即可。

## 许可证

代码基于 [MIT](LICENSE) 开源。鸟类数据为手工整理，仅供参考；环境音素材来自 Mixkit（免费音效协议）。
